...
I have to Update Kubernetes deployment to:
...
The error which I will get might be Accessing /api/health will return **404 Not Found page**

The error is Backend endpoint was /health but ingress routed /api/health**

 To fix this  
 I have to Update Flask app route to:
...
To fix this  
I have to Grant Contributor role on Storage Account and updated backend config in providers.tf then I have to varify it by commands using tf init

  
**4\. FluentBit Log Path Bug**  
Incorrect path: \*.logx instead of \*.log.

I have to correct the path, here “x” is extra so I think I have to remove this  
